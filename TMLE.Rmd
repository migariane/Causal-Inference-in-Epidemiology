...
##Step 5: Inference
TMLE uses the efficient influence curve (IC) for inference. The IC is used to obtain standard errors for $\psi$. 
...
2. Step two: predicted estimate for $g_{0}(A,W)$**
...
SL.TMLER.Psi <- tmle(Y=Y, A=A, W=w, family="binomial", 
    Q.SL.library = c("SL.glm", "SL.step", "SL.glm.interaction", "SL.gam", "SL.randomForest"),
    g.SL.library = c("SL.glm", "SL.step", "SL.glm.interaction", "SL.gam", "SL.randomForest"))
