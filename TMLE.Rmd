...
Alternatively, James Robins in 1986 demonstrated that using standardisation, implemented through the use of the **G-formula**, allows obtaining a unconfounded marginal estimation of the causal average treatment effect (ATE) or risk difference under causal untestable assumptions [@robins1986], [@robins2000].       
...
df <- round(cbind(Logit=(Q),Pr.A1=QA1,Pr.A0=QA0,Psi=psi), digits= 3)
```
